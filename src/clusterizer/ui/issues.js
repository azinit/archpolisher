var issues = {
	...
	"issues": [
		{
			"module": "pages/errors/404/index.scss",
			"similar": [
				"api/helpers/index.ts",
				"api/index.tsx",
				"components/card/item-compact/index.scss",
				"components/code-renderer/index.tsx",
				"components/comment/index.scss",
				"components/header/index.scss",
				"components/label/index.scss",
				"components/label/mutable/index.scss",
				"components/loader/index.scss",
				"components/rate/index.tsx",
				"components/text-field/index.scss",
				"components/text-field/index.tsx",
				"components/user/index.tsx",
				"index.css",
				"pages/auth/sign-in/index.scss",
				"pages/auth/sign-up/index.scss",
				"serviceWorker.ts",
				...
				"components/card/sheet/actions/index.scss",
				"components/card/sheet/index.scss",
				"components/list/index.scss",
				"pages/faves/index.scss",
				"pages/user-cards/index.scss",
				"components/dashboard/add/index.scss",
				"components/dashboard/index.scss",
				"components/dashboard/item/dashboard-actions/index.tsx",
				"components/dashboard/item/index.scss"
			]
		},
		{
			"module": "components/card/sheet/comments/comment-form/index.tsx",
			"similar": [
		...
		{
			"module": "pages/auth/sign-in/index.tsx",
			"similar": [
		...
		{
			"module": "pages/auth/sign-up/index.tsx",
			"similar": [
				"pages/card/index.tsx",
				"pages/dashboard/index.tsx",
				"pages/faves/index.tsx",
		...
		{
			"module": "pages/labels/form/index.tsx",
			"similar": [
				"pages/card/index.tsx",
				"pages/dashboard/index.tsx",
				"pages/faves/index.tsx",
	...
	"noise": [
		...
		"assets/faves.png",
		"assets/labels.png",
		"assets/markdown-compability.png",
